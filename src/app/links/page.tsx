...
const LINK_GROUPS: LinkGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Swagger — Dev',         url: 'https://devapi.pinnaclefundservices.com/swagger/index.html',            description: 'Dev API docs' },
      { label: 'Swagger — UAT',         url: 'https://uatapi.pinnaclefundservices.com/swagger/index.html',            description: 'UAT API docs' },
      { label: 'Swagger — Prod',        url: 'https://prodapi.pinnaclefundservices.com/swagger/index.html',           description: 'Production API docs' },
      { label: 'Swagger — Demo',        url: 'https://demoapi.pinnaclefundservices.com/swagger/index.html',           description: 'Demo API docs' },
      { label: 'Swagger — Test',        url: 'https://testapi.pinnaclefundservices.com/swagger/index.html',           description: 'Test API docs' },
